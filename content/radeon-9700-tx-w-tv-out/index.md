+++
title = "Is the Radeon 9700 TX w/TV-Out GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon 9700 TX w/TV-Out** GPU is sufficient.
...
The **Radeon 9700 TX w/TV-Out** GPU received a 3DMark score of **44**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon 9700 TX w/TV-Out</td>

+++
title = "Is the NVS 5200M GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **NVS 5200M** GPU is sufficient.
...
The **NVS 5200M** GPU received a 3DMark score of **514**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">NVS 5200M</td>
    <td>25h 7 minutes</td>
  </tr>
  <tr>

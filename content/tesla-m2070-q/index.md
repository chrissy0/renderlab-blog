+++
title = "Is the Tesla M2070-Q GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Tesla M2070-Q** GPU is sufficient.
...
The **Tesla M2070-Q** GPU received a 3DMark score of **1306**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Tesla M2070-Q</td>
    <td>9h 53 minutes</td>
  </tr>
  <tr>

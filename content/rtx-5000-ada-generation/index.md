+++
title = "Is the RTX 5000 Ada Generation GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **RTX 5000 Ada Generation** GPU is sufficient.
...
The **RTX 5000 Ada Generation** GPU received a 3DMark score of **23759**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 61.32% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">RTX 5000 Ada Generation</td>
    <td>32 minutes</td>
  </tr>
  <tr>

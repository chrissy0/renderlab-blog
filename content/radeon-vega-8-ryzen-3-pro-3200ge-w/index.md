+++
title = "Is the Radeon Vega 8 Ryzen 3 PRO 3200GE w/ GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon Vega 8 Ryzen 3 PRO 3200GE w/** GPU is sufficient.
...
The **Radeon Vega 8 Ryzen 3 PRO 3200GE w/** GPU received a 3DMark score of **1504**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 3.88% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon Vega 8 Ryzen 3 PRO 3200GE w/</td>
    <td>8h 35 minutes</td>
  </tr>
  <tr>

+++
title = "Is the MOBILITY FireGL V3200 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **MOBILITY FireGL V3200** GPU is sufficient.
...
The **MOBILITY FireGL V3200** GPU received a 3DMark score of **62**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">MOBILITY FireGL V3200</td>
    <td>208h 17 minutes</td>
  </tr>
  <tr>

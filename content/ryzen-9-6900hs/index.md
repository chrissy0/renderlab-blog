+++
title = "Is the Ryzen 9 6900HS GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Ryzen 9 6900HS** GPU is sufficient.
...
The **Ryzen 9 6900HS** GPU received a 3DMark score of **8005**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 20.66% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Ryzen 9 6900HS</td>
    <td>1h 36 minutes</td>
  </tr>
  <tr>

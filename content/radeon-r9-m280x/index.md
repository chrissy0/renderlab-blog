+++
title = "Is the Radeon R9 M280X GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon R9 M280X** GPU is sufficient.
...
The **Radeon R9 M280X** GPU received a 3DMark score of **814**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon R9 M280X</td>
    <td>15h 51 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Quadro FX 500/600 PCI GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Quadro FX 500/600 PCI** GPU is sufficient.
...
The **Quadro FX 500/600 PCI** GPU received a 3DMark score of **14**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Quadro FX 500/600 PCI</td>
    <td>922h 27 minutes</td>
  </tr>
  <tr>

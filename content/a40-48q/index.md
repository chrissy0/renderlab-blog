+++
title = "Is the A40-48Q GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **A40-48Q** GPU is sufficient.
...
The **A40-48Q** GPU received a 3DMark score of **17864**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 46.11% that of the GeForce RTX 4090, the currently fastest GPU on the market.

+++
title = "Is the MCT USB3.0 External Device GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **MCT USB3.0 External Device** GPU is sufficient.
...
The **MCT USB3.0 External Device** GPU received a 3DMark score of **520**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">MCT USB3.0 External Device</td>
    <td>24h 50 minutes</td>
  </tr>
  <tr>

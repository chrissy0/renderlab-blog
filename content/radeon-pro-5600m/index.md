+++
title = "Is the Radeon Pro 5600M GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon Pro 5600M** GPU is sufficient.
...
The **Radeon Pro 5600M** GPU received a 3DMark score of **9313**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 24.04% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon Pro 5600M</td>
    <td>1h 23 minutes</td>
  </tr>
  <tr>

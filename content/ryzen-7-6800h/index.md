+++
title = "Is the Ryzen 7 6800H GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Ryzen 7 6800H** GPU is sufficient.
...
The **Ryzen 7 6800H** GPU received a 3DMark score of **5248**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Ryzen 7 6800H</td>
    <td>2h 27 minutes</td>
  </tr>
  <tr>

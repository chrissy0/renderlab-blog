+++
title = "Is the MEDION RADEON X740XL GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **MEDION RADEON X740XL** GPU is sufficient.
...
The **MEDION RADEON X740XL** GPU received a 3DMark score of **95**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">MEDION RADEON X740XL</td>
    <td>135h 56 minutes</td>
  </tr>
  <tr>

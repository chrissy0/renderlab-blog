+++
title = "Is the Barco MXRT 5450 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Barco MXRT 5450** GPU is sufficient.
...
The **Barco MXRT 5450** GPU received a 3DMark score of **1079**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Barco MXRT 5450</td>
    <td>11h 58 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Radeon R7 A12-9730P RADEON GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon R7 A12-9730P RADEON** GPU is sufficient.
...
The **Radeon R7 A12-9730P RADEON** GPU received a 3DMark score of **1047**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 2.70% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon R7 A12-9730P RADEON</td>
    <td>12h 20 minutes</td>
  </tr>
  <tr>

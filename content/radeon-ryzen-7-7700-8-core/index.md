+++
title = "Is the Radeon Ryzen 7 7700 8-Core GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon Ryzen 7 7700 8-Core** GPU is sufficient.
...
The **Radeon Ryzen 7 7700 8-Core** GPU received a 3DMark score of **1708**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon Ryzen 7 7700 8-Core</td>
    <td>7h 33 minutes</td>
  </tr>
  <tr>

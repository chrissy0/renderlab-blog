+++
title = "Is the Mobile Intel - famiglia Express Chipset 45 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Mobile Intel - famiglia Express Chipset 45** GPU is sufficient.
...
The **Mobile Intel - famiglia Express Chipset 45** GPU received a 3DMark score of **39**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 0.10% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Mobile Intel - famiglia Express Chipset 45</td>
    <td>331h 8 minutes</td>
  </tr>
  <tr>

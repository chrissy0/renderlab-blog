+++
title = "Is the GRID K220Q GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **GRID K220Q** GPU is sufficient.
...
The **GRID K220Q** GPU received a 3DMark score of **912**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">GRID K220Q</td>
    <td>14h 9 minutes</td>
  </tr>
  <tr>

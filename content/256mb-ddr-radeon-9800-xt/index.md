+++
title = "Is the 256MB DDR Radeon 9800 XT GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **256MB DDR Radeon 9800 XT** GPU is sufficient.
...
The **256MB DDR Radeon 9800 XT** GPU received a 3DMark score of **38**. Here's how it compares to other common GPUs.

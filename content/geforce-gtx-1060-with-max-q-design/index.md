+++
title = "Is the GeForce GTX 1060 with Max-Q Design GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **GeForce GTX 1060 with Max-Q Design** GPU is sufficient.
...
The **GeForce GTX 1060 with Max-Q Design** GPU received a 3DMark score of **7879**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 20.34% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">GeForce GTX 1060 with Max-Q Design</td>
    <td>1h 38 minutes</td>
  </tr>
  <tr>

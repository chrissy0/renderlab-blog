+++
title = "Is the GeForce 800A GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **GeForce 800A** GPU is sufficient.
...
The **GeForce 800A** GPU received a 3DMark score of **477**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">GeForce 800A</td>
    <td>27h 4 minutes</td>
  </tr>
  <tr>

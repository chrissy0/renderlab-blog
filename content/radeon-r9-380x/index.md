+++
title = "Is the Radeon R9 380X GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon R9 380X** GPU is sufficient.
...
The **Radeon R9 380X** GPU received a 3DMark score of **6229**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon R9 380X</td>
    <td>2h 4 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Radeon RX Vega11 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon RX Vega11** GPU is sufficient.
...
The **Radeon RX Vega11** GPU received a 3DMark score of **1605**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon RX Vega11</td>
    <td>8h 2 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Microsoft Basic Display Adapter Ryzen 5 5600G GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Microsoft Basic Display Adapter Ryzen 5 5600G** GPU is sufficient.
...
The **Microsoft Basic Display Adapter Ryzen 5 5600G** GPU received a 3DMark score of **302**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 0.78% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Microsoft Basic Display Adapter Ryzen 5 5600G</td>
    <td>42h 45 minutes</td>
  </tr>
  <tr>

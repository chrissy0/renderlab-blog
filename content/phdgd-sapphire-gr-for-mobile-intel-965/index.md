+++
title = "Is the PHDGD Sapphire GR for Mobile Intel 965 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **PHDGD Sapphire GR for Mobile Intel 965** GPU is sufficient.
...
The **PHDGD Sapphire GR for Mobile Intel 965** GPU received a 3DMark score of **26**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 0.07% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">PHDGD Sapphire GR for Mobile Intel 965</td>
    <td>496h 42 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Citrix Indirect Display Adapter GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Citrix Indirect Display Adapter** GPU is sufficient.
...
The **Citrix Indirect Display Adapter** GPU received a 3DMark score of **4447**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 11.48% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Citrix Indirect Display Adapter</td>
    <td>2h 54 minutes</td>
  </tr>
  <tr>

+++
title = "Is the NVIDIA A40-12Q GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **NVIDIA A40-12Q** GPU is sufficient.
...
The **NVIDIA A40-12Q** GPU received a 3DMark score of **5573**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">NVIDIA A40-12Q</td>
    <td>2h 19 minutes</td>
  </tr>
  <tr>

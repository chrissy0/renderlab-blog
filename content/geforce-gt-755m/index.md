+++
title = "Is the GeForce GT 755M GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **GeForce GT 755M** GPU is sufficient.
...
The **GeForce GT 755M** GPU received a 3DMark score of **1687**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">GeForce GT 755M</td>
    <td>7h 39 minutes</td>
  </tr>
  <tr>

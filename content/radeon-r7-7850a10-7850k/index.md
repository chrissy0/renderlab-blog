+++
title = "Is the Radeon R7 7850A10-7850K GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon R7 7850A10-7850K** GPU is sufficient.
...
The **Radeon R7 7850A10-7850K** GPU received a 3DMark score of **551**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 1.42% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon R7 7850A10-7850K</td>
    <td>23h 26 minutes</td>
  </tr>
  <tr>

+++
title = "Is the GeForce GTX 650 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **GeForce GTX 650** GPU is sufficient.
...
The **GeForce GTX 650** GPU received a 3DMark score of **1750**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 4.52% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">GeForce GTX 650</td>
    <td>7h 22 minutes</td>
  </tr>
  <tr>

+++
title = "Is the GeForce 7300 LE GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **GeForce 7300 LE** GPU is sufficient.
...
The **GeForce 7300 LE** GPU received a 3DMark score of **80**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">GeForce 7300 LE</td>

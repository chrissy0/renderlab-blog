+++
title = "Is the Quadro M2000M GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Quadro M2000M** GPU is sufficient.
...
The **Quadro M2000M** GPU received a 3DMark score of **3463**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 8.94% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Quadro M2000M</td>
    <td>3h 43 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Barco MXRT 5600 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Barco MXRT 5600** GPU is sufficient.
...
The **Barco MXRT 5600** GPU received a 3DMark score of **2466**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 6.37% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Barco MXRT 5600</td>
    <td>5h 14 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Quadro4 900 XGL GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Quadro4 900 XGL** GPU is sufficient.
...
The **Quadro4 900 XGL** GPU received a 3DMark score of **5**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Quadro4 900 XGL</td>

+++
title = "Is the Radeon Ryzen 5 5600GE GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon Ryzen 5 5600GE** GPU is sufficient.
...
The **Radeon Ryzen 5 5600GE** GPU received a 3DMark score of **2531**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 6.53% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon Ryzen 5 5600GE</td>
    <td>5h 6 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Radeon Ryzen 7 4800U GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon Ryzen 7 4800U** GPU is sufficient.
...
The **Radeon Ryzen 7 4800U** GPU received a 3DMark score of **2305**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon Ryzen 7 4800U</td>
    <td>5h 36 minutes</td>
  </tr>
  <tr>

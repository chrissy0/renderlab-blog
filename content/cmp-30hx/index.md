+++
title = "Is the CMP 30HX GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **CMP 30HX** GPU is sufficient.
...
The **CMP 30HX** GPU received a 3DMark score of **4248**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 10.96% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">CMP 30HX</td>
    <td>3h 2 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Tesla K20Xm GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Tesla K20Xm** GPU is sufficient.
...
The **Tesla K20Xm** GPU received a 3DMark score of **2918**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Tesla K20Xm</td>
    <td>4h 25 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Radeon X1950 CrossFire Edition GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon X1950 CrossFire Edition** GPU is sufficient.
...
The **Radeon X1950 CrossFire Edition** GPU received a 3DMark score of **151**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 0.39% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon X1950 CrossFire Edition</td>
    <td>85h 31 minutes</td>
  </tr>
  <tr>

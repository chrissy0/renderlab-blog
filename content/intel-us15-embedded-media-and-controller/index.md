+++
title = "Is the Intel US15 Embedded Media and Controller GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Intel US15 Embedded Media and Controller** GPU is sufficient.
...
The **Intel US15 Embedded Media and Controller** GPU received a 3DMark score of **7**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Intel US15 Embedded Media and Controller</td>
    <td>1844h 54 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Radeon Ryzen 5 4600GE with Radeon Graphics GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon Ryzen 5 4600GE with Radeon Graphics** GPU is sufficient.
...
The **Radeon Ryzen 5 4600GE with Radeon Graphics** GPU received a 3DMark score of **1793**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 4.63% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon Ryzen 5 4600GE with Radeon Graphics</td>
    <td>7h 12 minutes</td>
  </tr>
  <tr>

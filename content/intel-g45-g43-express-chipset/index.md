+++
title = "Is the Intel G45/G43 Express Chipset GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Intel G45/G43 Express Chipset** GPU is sufficient.
...
The **Intel G45/G43 Express Chipset** GPU received a 3DMark score of **105**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 0.27% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Intel G45/G43 Express Chipset</td>
    <td>122h 59 minutes</td>
  </tr>
  <tr>

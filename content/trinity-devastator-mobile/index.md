+++
title = "Is the TRINITY DEVASTATOR MOBILE GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **TRINITY DEVASTATOR MOBILE** GPU is sufficient.
...
The **TRINITY DEVASTATOR MOBILE** GPU received a 3DMark score of **699**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 1.80% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">TRINITY DEVASTATOR MOBILE</td>
    <td>18h 28 minutes</td>
  </tr>
  <tr>

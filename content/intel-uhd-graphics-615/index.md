+++
title = "Is the Intel UHD Graphics 615 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Intel UHD Graphics 615** GPU is sufficient.
...
The **Intel UHD Graphics 615** GPU received a 3DMark score of **741**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Intel UHD Graphics 615</td>
    <td>17h 25 minutes</td>
  </tr>
  <tr>

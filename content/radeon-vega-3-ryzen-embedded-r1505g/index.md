+++
title = "Is the Radeon Vega 3 Ryzen Embedded R1505G GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon Vega 3 Ryzen Embedded R1505G** GPU is sufficient.
...
The **Radeon Vega 3 Ryzen Embedded R1505G** GPU received a 3DMark score of **758**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon Vega 3 Ryzen Embedded R1505G</td>
    <td>17h 2 minutes</td>
  </tr>
  <tr>

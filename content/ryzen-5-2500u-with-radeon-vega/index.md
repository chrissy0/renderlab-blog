+++
title = "Is the Ryzen 5 2500U with Radeon Vega GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Ryzen 5 2500U with Radeon Vega** GPU is sufficient.
...
The **Ryzen 5 2500U with Radeon Vega** GPU received a 3DMark score of **1503**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Ryzen 5 2500U with Radeon Vega</td>
    <td>8h 35 minutes</td>
  </tr>
  <tr>

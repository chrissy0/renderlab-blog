+++
title = "Is the Radeon R7 + HD 7700 Dual GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon R7 + HD 7700 Dual** GPU is sufficient.
...
The **Radeon R7 + HD 7700 Dual** GPU received a 3DMark score of **1962**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon R7 + HD 7700 Dual</td>
    <td>6h 34 minutes</td>
  </tr>
  <tr>

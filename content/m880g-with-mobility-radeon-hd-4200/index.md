+++
title = "Is the M880G with Mobility Radeon HD 4200 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **M880G with Mobility Radeon HD 4200** GPU is sufficient.
...
The **M880G with Mobility Radeon HD 4200** GPU received a 3DMark score of **93**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 0.24% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">M880G with Mobility Radeon HD 4200</td>
    <td>138h 51 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Radeon R7 + R7 200 Dual GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon R7 + R7 200 Dual** GPU is sufficient.
...
The **Radeon R7 + R7 200 Dual** GPU received a 3DMark score of **1077**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 2.78% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon R7 + R7 200 Dual</td>
    <td>11h 59 minutes</td>
  </tr>
  <tr>

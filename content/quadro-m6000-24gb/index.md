+++
title = "Is the Quadro M6000 24GB GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Quadro M6000 24GB** GPU is sufficient.
...
The **Quadro M6000 24GB** GPU received a 3DMark score of **11884**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 30.67% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Quadro M6000 24GB</td>
    <td>1h 5 minutes</td>
  </tr>
  <tr>

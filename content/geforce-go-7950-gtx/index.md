+++
title = "Is the GeForce Go 7950 GTX GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **GeForce Go 7950 GTX** GPU is sufficient.
...
The **GeForce Go 7950 GTX** GPU received a 3DMark score of **264**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 0.68% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">GeForce Go 7950 GTX</td>
    <td>48h 55 minutes</td>
  </tr>
  <tr>

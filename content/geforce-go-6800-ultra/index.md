+++
title = "Is the GeForce Go 6800 Ultra GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **GeForce Go 6800 Ultra** GPU is sufficient.
...
The **GeForce Go 6800 Ultra** GPU received a 3DMark score of **138**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">GeForce Go 6800 Ultra</td>
    <td>93h 34 minutes</td>
  </tr>
  <tr>

+++
title = "Is the PHDGD Solo 1.2.0 x86 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **PHDGD Solo 1.2.0 x86** GPU is sufficient.
...
The **PHDGD Solo 1.2.0 x86** GPU received a 3DMark score of **11**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">PHDGD Solo 1.2.0 x86</td>
    <td>1174h 1 minutes</td>
  </tr>
  <tr>

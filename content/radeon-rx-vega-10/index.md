+++
title = "Is the Radeon RX Vega 10 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon RX Vega 10** GPU is sufficient.
...
The **Radeon RX Vega 10** GPU received a 3DMark score of **1642**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon RX Vega 10</td>
    <td>7h 51 minutes</td>
  </tr>
  <tr>

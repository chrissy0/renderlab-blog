+++
title = "Is the Radeon R6 PRO A10-8700B 4C+6G GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon R6 PRO A10-8700B 4C+6G** GPU is sufficient.
...
The **Radeon R6 PRO A10-8700B 4C+6G** GPU received a 3DMark score of **538**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon R6 PRO A10-8700B 4C+6G</td>
    <td>24h 0 minutes</td>
  </tr>
  <tr>

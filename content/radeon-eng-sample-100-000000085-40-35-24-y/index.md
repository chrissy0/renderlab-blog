+++
title = "Is the Radeon Eng Sample: 100-000000085-40_35/24_Y GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon Eng Sample: 100-000000085-40_35/24_Y** GPU is sufficient.
...
The **Radeon Eng Sample: 100-000000085-40_35/24_Y** GPU received a 3DMark score of **1441**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 3.72% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon Eng Sample: 100-000000085-40_35/24_Y</td>
    <td>8h 57 minutes</td>
  </tr>
  <tr>

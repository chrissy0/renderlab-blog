+++
title = "Is the Intel 915G/915GV/910GL Embedded Controller Functio GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Intel 915G/915GV/910GL Embedded Controller Functio** GPU is sufficient.
...
The **Intel 915G/915GV/910GL Embedded Controller Functio** GPU received a 3DMark score of **5**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Intel 915G/915GV/910GL Embedded Controller Functio</td>
    <td>2582h 52 minutes</td>
  </tr>
  <tr>

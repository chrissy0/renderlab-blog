+++
title = "Is the VIA Chrome9 HC IGP Prerelease WDDM 1.1 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **VIA Chrome9 HC IGP Prerelease WDDM 1.1** GPU is sufficient.
...
The **VIA Chrome9 HC IGP Prerelease WDDM 1.1** GPU received a 3DMark score of **2**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">VIA Chrome9 HC IGP Prerelease WDDM 1.1</td>
    <td>6457h 10 minutes</td>
  </tr>
  <tr>

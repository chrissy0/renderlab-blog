+++
title = "Is the Radeon 3015e GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon 3015e** GPU is sufficient.
...
The **Radeon 3015e** GPU received a 3DMark score of **371**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon 3015e</td>
    <td>34h 48 minutes</td>
  </tr>
  <tr>

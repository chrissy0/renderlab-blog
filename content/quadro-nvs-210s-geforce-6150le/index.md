+++
title = "Is the Quadro NVS 210S / GeForce 6150LE GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Quadro NVS 210S / GeForce 6150LE** GPU is sufficient.
...
The **Quadro NVS 210S / GeForce 6150LE** GPU received a 3DMark score of **21**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 0.05% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Quadro NVS 210S / GeForce 6150LE</td>
    <td>614h 58 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Mobile Intel 965 Express - BR-0907-0461 v1839 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Mobile Intel 965 Express - BR-0907-0461 v1839** GPU is sufficient.
...
The **Mobile Intel 965 Express - BR-0907-0461 v1839** GPU received a 3DMark score of **8**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 0.02% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Mobile Intel 965 Express - BR-0907-0461 v1839</td>
    <td>1614h 17 minutes</td>
  </tr>
  <tr>

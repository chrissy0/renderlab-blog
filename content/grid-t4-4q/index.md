+++
title = "Is the GRID T4-4Q GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **GRID T4-4Q** GPU is sufficient.
...
The **GRID T4-4Q** GPU received a 3DMark score of **3260**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 8.41% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">GRID T4-4Q</td>
    <td>3h 57 minutes</td>
  </tr>
  <tr>

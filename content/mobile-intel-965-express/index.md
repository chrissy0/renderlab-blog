+++
title = "Is the Mobile Intel 965 Express GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Mobile Intel 965 Express** GPU is sufficient.
...
The **Mobile Intel 965 Express** GPU received a 3DMark score of **48**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Mobile Intel 965 Express</td>
    <td>269h 2 minutes</td>
  </tr>
  <tr>

+++
title = "Is the A6 Micro-6500T Quad-Core APU with RadeonR4 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **A6 Micro-6500T Quad-Core APU with RadeonR4** GPU is sufficient.
...
The **A6 Micro-6500T Quad-Core APU with RadeonR4** GPU received a 3DMark score of **220**. Here's how it compares to other common GPUs.

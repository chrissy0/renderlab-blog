+++
title = "Is the Intel 82915G/GV/910GL Advanced v3.5 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Intel 82915G/GV/910GL Advanced v3.5** GPU is sufficient.
...
The **Intel 82915G/GV/910GL Advanced v3.5** GPU received a 3DMark score of **3**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Intel 82915G/GV/910GL Advanced v3.5</td>

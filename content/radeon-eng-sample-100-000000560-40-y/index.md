+++
title = "Is the Radeon Eng Sample: 100-000000560-40_Y GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon Eng Sample: 100-000000560-40_Y** GPU is sufficient.
...
The **Radeon Eng Sample: 100-000000560-40_Y** GPU received a 3DMark score of **4551**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 11.75% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon Eng Sample: 100-000000560-40_Y</td>
    <td>2h 50 minutes</td>
  </tr>
  <tr>

+++
title = "Is the Radeon Athlon PRO 3045B GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Radeon Athlon PRO 3045B** GPU is sufficient.
...
The **Radeon Athlon PRO 3045B** GPU received a 3DMark score of **555**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 1.43% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Radeon Athlon PRO 3045B</td>
    <td>23h 16 minutes</td>
  </tr>
  <tr>

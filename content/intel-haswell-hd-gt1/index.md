+++
title = "Is the Intel Haswell HD - GT1 GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Intel Haswell HD - GT1** GPU is sufficient.
...
The **Intel Haswell HD - GT1** GPU received a 3DMark score of **123**. Here's how it compares to other common GPUs.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Intel Haswell HD - GT1</td>
    <td>104h 59 minutes</td>
  </tr>
  <tr>

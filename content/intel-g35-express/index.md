+++
title = "Is the Intel G35 Express GPU good enough for Blender in 2024?"
date = "2024-04-07"
+++

If you're planning on rendering complex Blender scenes, you might be wondering if your computer is up to the task. In this post we will explore wether or not the **Intel G35 Express** GPU is sufficient.
...
The **Intel G35 Express** GPU received a 3DMark score of **2097**. Here's how it compares to other common GPUs.

![](comparison.svg)

The benchmark shows a performance of 5.41% that of the GeForce RTX 4090, the currently fastest GPU on the market.
...
<table>
  ...
  <tr>
    <td style="padding: 0 15px 0 0;">Intel G35 Express</td>
    <td>6h 9 minutes</td>
  </tr>
  <tr>
